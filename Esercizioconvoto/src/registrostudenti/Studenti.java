...
public class Studenti {
	...
	private String nome; // restrizione dell'accesso alle variabili ai solo metodi all'interno della
							// classe Studenti
	private String cognome;
	private String matricola;// per ogni studente la matricola deve essere diversa, valuta se lasciarla in
								// stringa o in int
